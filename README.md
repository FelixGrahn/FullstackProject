Detta project är en spinoff av kittenwars som använder sig av React, Express, Javascript, CSS och Node. Den använder sig av en databas som är hostad av Firestore och den är publiserad på Heroku.
